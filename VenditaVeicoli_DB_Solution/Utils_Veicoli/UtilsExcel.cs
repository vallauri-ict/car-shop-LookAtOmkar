...
namespace VenditaVeicoliDLLProject
{
    ...
    {
        public static void CreateExcelFile<T>(List<T> data, string OutPutFileDirectory)
        {
            var datetime = DateTime.Now.ToString().Replace("/", "_").Replace(":", "_");

            string fileFullname = Path.Combine(OutPutFileDirectory, "Volantino_Veicoli.xlsx");
        ...
        private static Row CreateHeaderRowForExcel(object testmodel) //ciò che deve apparire
        {
            Row workRow = new Row();
            //var Prop_Values = GetProperties(testmodel); DA RIVEDERE
            //foreach (var p in Prop_Values)
            //{
            //    workRow.Append(CreateCell(p.GetValues(testmodel, null).toString()));
            //}
            return workRow;
        }

        private static Row GenerateRowForChildPartDetail(object testmodel) //va a prendere l'oggetto dalla sua lista, la sua rappresentazione
        {
            Row tRow = new Row();
            //var Prop_values = GetProperties(testmodel);
            //foreach (var p in Prop_values) /// Let mi dava errore, quindi ho dovuto usare var
            //{
            //    tRow.Append(CreateCell(p.Getvalues(testmodel, null).toString()));
            //}
        ...
        private static EnumValue<CellValues> ResolveCellDataTypeOnValue(string text) //cerca di trasformare le stringhe in numeri
        {
            int intVal;
            double doubleVal;
